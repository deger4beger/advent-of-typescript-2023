// Solution
type FindSantaSingle<T, R extends [...unknown[]] = []> = 
  T extends [infer Head, ...infer Rest] 
	? Head extends '🎅🏼'
		? R['length']
		: FindSantaSingle<Rest, [...R, Head]>
	: unknown; 

type FindSanta<T, R extends [...unknown[]] = []> = 
  T extends [infer Head, ...infer Rest] 
	? FindSantaSingle<Head> extends infer Col
		? Col extends number ? [R['length'], Col]
		: FindSanta<Rest, [...R, "stub"]>
	: never : never; 
