// Solution
type Count<T1 extends string[], T2 extends string, Result extends string[] = []> = 
	T1 extends [infer Head, ...infer Rest extends string[]] 
	? Head extends T2 
		? Count<Rest, T2, [...Result, Head]>
		: Count<Rest, T2, [...Result]>
	: Result['length'];
